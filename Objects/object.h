...
enum Type {
    ...
    PATCH = PATCHC0 | PATCHC2,
    PATCHCREATOR = PATCHC0CREATOR | PATCHC2CREATOR,
    MOVABLE = POINT3D | TORUS | COMPOSITE | CURSOR | VIRTUALPOINT3D | PATCH | PATCHCREATOR | COMPOSABLEVIRTUALPOINT3D,
    NAMEABLE = POINT3D | TORUS | CURVE | PATCH | PATCHCREATOR,
    TRANSFORMABLE = TORUS | COMPOSITE | PATCH | PATCHCREATOR,
    SCREENMOVABLE = CURSOR,
    VIRTUALPOINTSHOLDER = BREZIERC2 | PATCH,
    COMPOSABLE = POINT3D | TORUS | COMPOSITE | COMPOSABLEVIRTUALPOINT3D | PATCH,
    VIRTUAL = CURSOR | VIRTUALPOINT3D | COMPOSABLEVIRTUALPOINT3D | PATCHCREATOR,
    PARAMETRIC = TORUS | PATCH | PATCHCREATOR,
    SCREENSELECTABLE = POINT3D | TORUS | COMPOSITE | COMPOSABLEVIRTUALPOINT3D,
};
