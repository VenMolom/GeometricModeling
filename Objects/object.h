...
enum Type {
    ...
    MOVABLE = POINT3D | TORUS | COMPOSITE | CURSOR | VIRTUALPOINT3D | PATCHC0 | PATCHC2 | PATCHCREATOR | COMPOSABLEVIRTUALPOINT3D,
    NAMEABLE = POINT3D | TORUS | CURVE | PATCH | PATCHCREATOR | INTERSECTION,
