...
#ifndef MG1_BICUBICC0CREATOR_H
#define MG1_BICUBICC0CREATOR_H

#include "bicubicC0.h"
#include "patchCreator.h"

class BicubicC0Creator : public BicubicC0, public PatchCreator {
public:
    BicubicC0Creator(const DirectX::XMFLOAT3 &position, const QBindable<std::weak_ptr<Object>> &bindableSelected);
